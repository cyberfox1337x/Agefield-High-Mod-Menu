...
- Added the true one-click per-machine Windows installer for the desktop app and verified game runtime.
- Added official Steam App ID/build/executable validation and fail-closed eligibility checks.
